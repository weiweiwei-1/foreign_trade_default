<template>
  <div id="user-block" @click="closeUserWindow">
    <div id="user-box">>
      <div id="user-center">
        <div id="user-head">
          <div id="img-block">
            <input :disabled="disable" title="点击上传图片(小于5M)" type="file" @change="changeImage" class="img-file"
        ...
        <div id="user-detail">
          <ul>
            ...
            <li><span>名字</span>：<span class="mark">*</span><input :readonly="readStatus" type="text" v-model="name"
                                                                  @input="warnCancel"></li>
            <li><span>城市</span>：<span class="mark">*</span><input :readonly="readStatus" type="text" v-model="city"
                                                                  @input="warnCancel"></li>
            <li><span>公司</span>：<span class="mark">*</span><input :readonly="readStatus" type="text" v-model="company"
                                                                  @input="warnCancel"></li>
            <li><span>公司官网</span>：<span class="mark"></span><input :readonly="readStatus" type="text"
                                                                   v-model="companyLink" @input="warnCancel"></li>
            <li><span>性别</span>：<span class="mark"></span><input :readonly="readStatus" type="text" v-model="sex"
                                                                 @input="warnCancel"></li>
            <li><span>年龄</span>：<span class="mark"></span><input :readonly="readStatus" type="text" v-model="age"
                                                                 @input="warnCancel"></li>
            <li><span>经验(年)</span>：<span class="mark"></span><input :readonly="readStatus" type="text"
                                                                    v-model="workingTime" @input="warnCancel"></li>
            <li><span>主营业务</span>：<span class="mark"></span><input :readonly="readStatus" type="text"
                                                                   v-model="mainBussinessScope" @input="warnCancel">
            </li>
            <li><span>服务优势</span>：<span class="mark"></span><input :readonly="readStatus" type="text"
                                                                   v-model="serviceAdvantage" @input="warnCancel"></li>
            <li><span>微信</span>：<span class="mark"></span><input :readonly="readStatus" type="text" v-model="weChat"
                                                                 @input="warnCancel"></li>
            <li><span>手机号</span>：<span class="mark"></span><input :readonly="readStatus" type="text" v-model="phone"
                                                                  @input="warnCancel"></li>
            <li><span>邮箱</span>：<span class="mark"></span><input :readonly="readStatus" type="text" v-model="email"
                                                                 @input="warnCancel"></li>
          </ul>
        </div>
        <div id="edit-block">
          <div id="block-content">
            ...
            <button @click="saveUserInfo" :disabled="disable">保存</button>
            <button @click="showUpdateWin">修改密码</button>
            <button @click="logoutAction">注销</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <update-pwd v-if="updatePwdShow" @closePwdWin="closePwdWin"></update-pwd>
      ...
      logout().then(res => {
        switch (res.code) {
          case -1:
            ...
            break
          case 1:
            messageShow('success', '成功退出登录！', 1000)
