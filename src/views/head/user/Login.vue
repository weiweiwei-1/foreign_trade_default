<template>
  <div id="login-content">
    <div class="block" id="email-block">
      <div class="content">
        <input @blur="onEmailInfo" @focus="onCancelEmailInfo" type="text" id="login-email" v-model="email"
               placeholder="输入邮箱">
      </div>
    ...
    <div class="block">
      <div class="content">
        <input @blur="onPasswordInfo" @focus="onCancelPwdInfo" type="password" id="login-password" v-model="password"
               placeholder="输入密码">
      </div>
      <div class="error-block">
