            ...
            <div id="product-info">
                ...
                <div id="detail-info">
                    <ul>
                        ...
                        <li class="long-info"><span class="product-key">备注</span><span class="mark">:</span><span class="value" id="information">{{curProductInfo.remark}}</span></li>
                    </ul>
                </div>
            </div>
            <div id="quote-info">
    ...
    export default {
        ...
        setup(props, context) {
            ...
            const showWindow = () => {
                ...
                console.log(curProductInfo.productName)
            };
